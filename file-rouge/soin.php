...
$sth = $conn->query("SELECT * FROM professionnels_service P INNER JOIN services S ON P.ID_Service = S.ID_Service WHERE S.Catégorie = 'soin du visage'");
$sth->execute();
                    ...
                    <div class='modal-body'>
                        ...
                        <form action='process_reservation.php' method='POST'>
                            ...
                            <div class='mb-3'>
                                ...
                                <input type='text' class='form-control' id='nom' value=". $nom." name='nom' required>
                            </div>
                            <div class='mb-3'>
                                <label for='prenom' class='form-label'>Prénom</label>
                                <input type='text' class='form-control' id='prenom' value=". $prenom." name='prenom' required>
                            </div>
                            <div class='mb-3'>
                            ...
                            <div class='mb-3'>
                                ...
                                <input type='tel' id='tele' name='tele' value=". $tele ." class='form-control' pattern='[0]{1}[5-8]{1}[0-9]{8}'>
                            </div>
